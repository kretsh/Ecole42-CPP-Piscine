...
/*   Updated: 2022/02/06 16:18:42 by cowen            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const std::string name) : _hitPoints(10), _energyPoints(10), _attackDamage(0){
	std::cout << "Constructor with name (ClapTrap) called" << std::endl;
	_name = name;
}

ClapTrap::ClapTrap(const ClapTrap & rhs) : _hitPoints(10), _energyPoints(10), _attackDamage(0){
	std::cout << "Copy assig. constructor (ClapTrap) called" << std::endl;
	_name = rhs._name;
}
